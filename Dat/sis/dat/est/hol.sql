    ...
    DELETE FROM `sis-dat_est` WHERE `esq` = 'hol' AND `ide` LIKE 'sol%'; INSERT INTO `sis-dat_est` VALUES
      ...
      ('hol','sol_pla', '{
        ...
        "inf": { 
          ...
          "htm-1": { "eti":"p", "class":"tit", "htm":"Los <n>20</n> <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_03-02-\'>Sellos Solares</a> del Código <n>0<c>-</c>19</n>" },
          "fic-1": [ "sel" ],
          
          "htm-2": { "eti":"p", "class":"tit", "htm":"Los <n>4</n> <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_04-01-\'>Clanes Cromáticos</a> de la Colocación Cromática" },
          "fic-2": [ "ele" ],

          "htm-3": { "eti":"p", "class":"tit", "htm":"Las <n>5</n> <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_04-02-\'>Familias Terrestres</a> de la Colocación Cromática" },
          "fic-3": [ "fam" ]
        }
      }' ),
      ('hol','sol_orb', '{
        ...
        "inf": { 
          ...
          "htm-1": { "eti":"p", "class":"tit", "htm":"Las <n>10</n> <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_06-01-\'>Órbitas Planetarias</a> del Código <n>0<c>-</c>19</n>" },
          "fic-1": [ "pla" ],
      ...
      ('hol','sol_cel', '{
        ...
        "inf": { 
          ...
          "htm-2": { "eti":"p", "class":"tit", "htm":"Los <n>20</n> <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_03-02-\'>Sellos Solares</a> del Código <n>0<c>-</c>19</n>" },
          "fic-2": [ "sel" ],

          "htm-3": { "eti":"p", "class":"tit", "htm":"Los <n>4</n> <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_04-01-\'>Clanes Cromáticos</a> de la Colocación Cromática" },
          "fic-3": [ "ele" ],

          "htm-4": { "eti":"p", "class":"tit", "htm":"Las <n>5</n> <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_04-02-\'>Familias Terrestres</a> de la Colocación Cromática" },
          "fic-4": [ "fam" ]
        }
      }' ),
      ('hol','sol_cir', '{
    ...
    DELETE FROM `sis-dat_est` WHERE `esq` = 'hol' AND `ide` LIKE 'hum%'; INSERT INTO `sis-dat_est` VALUES
      ...
      ('hol','hum_mer', '{
        ...
        "inf": { 
          ...
          "htm-1": { "eti":"p", "class":"tit", "htm":"Los <n>4</n> <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_04-01-\'>Clanes Cromáticos</a>" },
          "fic-1": [ "ele" ],
      ...
      ('hol','hum_art', '{
        ...
        "inf": { 
          ...
          "htm": { "eti":"p", "class":"tit", "htm":"Los <n>13</n> <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/tono#_01-\'>Tonos Galácticos</a> como Rayos de Pulsación" },
          "fic": [ "ton" ]
        }
      }' ),
      ('hol','hum_sen', '{
    ...
    DELETE FROM `sis-dat_est` WHERE `esq` = 'hol' AND `ide` LIKE 'tel%'; INSERT INTO `sis-dat_est` VALUES
      ...
      ('hol','tel_cub', '{  
        "atr": { 
          ...
          "lun": { "min":1, "max":28, "dat":"hol-lun" }
        },
        "val": {
          "nom": "Cubo del Día #()($)ide() de 16: ()($)nom().",
          "des": "()($)tit(): ()($)lec().",
          "ima": "background: center/contain no-repeat url(http://localhost/_img/hol/fic/sel/()($)sel().png);",
          "col": 4,
          "num": 16
        },
        "opc": {
  ...
  -- Códigos
    ...
    DELETE FROM `sis-dat_est` WHERE `esq` = 'hol' AND `ide` LIKE 'rad%'; INSERT INTO `sis-dat_est` VALUES
      ...
      ('hol','rad', '{
        ...
        "inf": {
          ...
          "htm-1": { "eti":"p", "class":"tit", "htm":"Los <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/plasma#_02-\'>Oráculos y las Profecías</a> del <cite>Telektonon</cite>" },
          "tex-1": "()($)tel() ( ()($)tel_año() ): ()($)tel_des().",
          "fic-1-tit": [ "tel_ora_año", "tel_ora_ani", "tel_ora_gen" ],
          
          "htm-2": { "eti":"p", "class":"tit", "htm":"Las <a target=\'_blank\' href=\'http://localhost/sincronario/libro/proyecto_rinri#_02-05-01-\'>Funciones Anuales</a> en <cite>el Proyecto Rinri</cite>" },
          "atr-2": "rin_des",

          "htm-3": { "eti":"p", "class":"tit", "htm":"Las <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/plasma#_03-01\'>Líneas de Fuerza</a> de los Componentes Electrónicos de la Energía Cósmica" },
          "atr-3": "pla_des",
          "fic-3": [ "pla_fue" ],

          "htm-4": { "eti":"p", "class":"tit", "htm":"Las <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/plasma#_01-01-\'>Autodeclaraciones Diarias de Padmasambhava</a> en el Átomo del Tiempo" },
          "atr-4": "pla_lec",
          "fic-4": [ "pla_qua" ],

          "htm-5": { "eti":"p", "class":"tit", "htm":"Los <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/plasma#_04-01-\'>Chakras y el Cubo del Radión</a> del Plasma Radial" },
      ...
      ('hol','rad_pla_fue', '{
        ...
        "inf": {
          ...
          "htm-1": { "eti":"p", "class":"tit", "htm":"Los <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/plasma#_03-02-\'>Tipos de Electricidad</a> en los Componentes Electrónicos de la Energía Cósmica" },
    ...
    DELETE FROM `sis-dat_est` WHERE `esq` = 'hol' AND `ide` LIKE 'ton%'; INSERT INTO `sis-dat_est` VALUES
      ...
      ('hol','ton', '{
        ...
        "inf": {
          ...
          "htm-1": { "eti":"p", "class":"tit", "htm":"Los <n>13</n> <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/tono#_01-\'>Rayos de Pulsación</a> del Centro Galáctico" },
          "atr-1": "gal",

          "htm-2": { "eti":"p", "class":"tit", "htm":"Los <n>13</n> <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/tono#_02-\'>Tonos Galácticos</a> de la Creación" },
          "tex-2": "()($)des(), ()($)des_acc_lec().",

          "htm-3": { "eti":"p", "class":"tit", "htm":"La <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/tono#_03-\'>Onda Encantada</a> de la Aventura" },
          ...
          "htm-5": { "eti":"p", "class":"tit", "htm":"Extractos del libro<c>:</c> <cite>El kin<c>,</c> tu signo maya</cite> " },
      ...
      ('hol','ton_ond', '{
        ...
        "inf": { 
          ...
          "htm": { "eti":"p", "class":"tit", "htm":"La <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/tono#_03-\'>Onda Encantada</a> de la Aventura" },
          "fic": [ "ton" ]
        }
      }' ),
      -- pulsares
      ('hol','ton_dim', '{
        ...
        "inf": { 
          ...
          "htm": { "eti":"p", "class":"tit", "htm":"Los <n>4</n> <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/tono#_02-01-\'>Pulsares Dimensionales</a> de la Onda Encantada" },
          "atr": [ "des_ond" ],
          "fic": [ "ton" ]
      ...
      ('hol','ton_mat', '{
        ...
        "inf": { 
          ...
          "htm": { "eti":"p", "class":"tit", "htm":"Los <n>5</n> <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/tono#_02-02-\'>Pulsares Matices</a> de la Onda Encantada" },
          "atr": [ "des_ond" ],
          "fic": [ "ton" ]
        }
      }' ),
      ('hol','ton_sim', '{
        ...
        "inf": { 
          ...
          "htm": { "eti":"p", "class":"tit", "htm":"Los <n>7</n> <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/tono#_01-01-\'>Pares Especulares</a> de los Rayos de Pulsación Galáctica" },
          "atr": [ "fac_des" ],
          "fic": [ "ton" ]
        }
      }' )
    ...
    DELETE FROM `sis-dat_est` WHERE `esq` = 'hol' AND `ide` LIKE 'sel%'; INSERT INTO `sis-dat_est` VALUES
      ...
      ('hol','sel', '{
        ...
        "inf": { 
          ...
          "htm-1-1": { "eti":"p", "class":"tit", "htm":"Las <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_02-02-\'>Etapas</a> en el desarrollo del Ser" },
          "atr-1-1": [ "cic_ser_des" ],

          "htm-1-2": { "eti":"p", "class":"tit", "htm":"Las <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_02-03-\'>Familias Cíclicas</a> de la Luz" },
          "atr-1-2": [ "cic_luz_des" ],

          "htm-1-3": { "eti":"p", "class":"tit", "htm":"El <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/kin#_04-01-\'>Modelo Morfogenético</a> del Rayo de Sincronización Galáctica" },
          "atr-1-3": [ "arm_tra_des" ],
          
          "htm-2": { "eti":"p", "class":"tit", "htm":"La <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_05-\'>Colocación Armónica</a>" },
          "tab-2": [ "hol.sel_arm", { 
            "val": { "pos":"()($)ide()" }, 
            "pos": { "ima":"hol.sel.ide" } 
          } ],
          ...
          "htm-3": { "eti":"p", "class":"tit", "htm":"La <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_04-\'>Colocación Cromática</a>" },
          "tab-3": [ "hol.sel_cro", { 
            "val": { "pos":"()($)ide()" }, 
            "pos": { "ima":"hol.sel.ide" } 
          } ],
      ...
      ('hol','sel_arm_raz', '{
        ...
        "inf": {
          ...
          "htm": { "eti":"p", "class":"tit", "htm":"La <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_05-\'>Colocación Armónica</a>" },
          "fic": [ "sel" ]
        }
      }' ),
      ('hol','sel_arm_cel', '{
      ...
      ('hol','sel_cro_fam', '{
        ...
        "inf": { 
          ...
          "htm": { "eti":"p", "class":"tit", "htm":"Las <n>5</n> <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_04-02-\'>Familias Terrestres</a> de la Nación Arcoíris" },
          "fic": [ "sel" ],

          "htm-1": { "eti":"p", "class":"tit", "htm":"El <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_07-\'>Holon Planetario</a>" },
          "fic-1": [ "pla_cen" ], 

          "htm-2": { "eti":"p", "class":"tit", "htm":"El <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_08-\'>Holon Humano</a>" },
      ...
      ('hol','sel_cro_ele', '{
        ...
        "inf": { 
          ...
          "htm-1": { "eti":"p", "class":"tit", "htm":"La <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_04-\'>Colocación Cromática</a>" },
          "fic-1": [ "sel" ],
          
          "htm-1": { "eti":"p", "class":"tit", "htm":"Las <n>5</n> <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/sello#_05-01-\'>Células del Tiempo</a> del Íncide Armónico" },
          "fic-2": [ "arm_cel" ]
        }
      }' )
    ;
    ...
    DELETE FROM `sis-dat_est` WHERE `esq` = 'hol' AND `ide` LIKE 'cas%'; INSERT INTO `sis-dat_est` VALUES
      ...
      ('hol','cas_arm', '{
        ...
        "inf": {
          ...
          "htm": { "eti":"p", "class":"tit", "htm":"El <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/tono#_03-01-\'>Castillo del Destino</a>" },
      ...
      ('hol','cas_ond', '{
        ...
        "inf": {
          ...
          "htm": { "eti":"p", "class":"tit", "htm":"La <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/tono#_03-\'>Onda Encantada de la Aventura</a>" },
    ...
    DELETE FROM `sis-dat_est` WHERE `esq` = 'hol' AND `ide` LIKE 'kin%'; INSERT INTO `sis-dat_est` VALUES
      ...
      ('hol','kin', '{
        ...
        "inf": { 
          ...
          "htm-1": { "eti":"p", "class":"tit", "htm":"La <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/kin#_05-\'>Nave del Tiempo</a>" },
          "fic-1": [ "nav_cas", "nav_ond", "nav_ond_dia" ],

          "htm-3": { "eti":"p", "class":"tit", "htm":"El <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/kin#_04-\'>Giro Galáctico</a>" },
          "fic-3": [ "arm_tra", "arm_cel", "arm_tra_dia" ],

          "htm-2": { "eti":"p", "class":"tit", "htm":"El <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/kin#_03-\'>Giro Espectral</a>" },
          "fic-2": [ "cro_est", "cro_ele" ],        

          "htm-4": { "eti":"p", "class":"tit", "htm":"El <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/kin#_06-\'>Oráculo del Destino</a>" },
          "eje-4": { "ide": "App/Sincronario::dat_inf", "par": [ "kin_par", "()($)ide()" ] }        
        }
      }'),
      -- parejas del oraculo
      ('hol','kin_par', '{
      ...
      ('hol','kin_arm_tra', '{
        ...
        "inf": {
          ...
          "htm-1": { "eti":"p", "class":"tit", "htm":"El <a target=\'_blank\' href=\'http://localhost//sincronario/libro/factor_maya#_05-04-\'>Rayo de Sincronización Galáctica</a> en el Factor Maya" },
          "atr-1": [ "lec" ],
          
          "htm-2": { "eti":"p", "class":"tit", "htm":"El <a target=\'_blank\' href=\'http://localhost//sincronario/libro/encantamiento_del_sueño#_04-\'>Índice Armónico</a> en <cite>el Encantamiento del Sueño</cite>" },
          "atr-2": [ "des" ],
          "fic-2": [ "cel" ]
        }
      }' ),
      ('hol','kin_arm_cel', '{ 
        ...
        "inf": {
          ...
          "htm-1": { "eti":"p", "class":"tit", "htm":"El <a target=\'_blank\' href=\'http://localhost//sincronario/libro/tablas_del_tiempo#_06-04-\'>I-Ching Galáctico</a> en Las 20 Tablas del Tiempo" },
          "fic-1": [ "chi" ],

          "htm-2": { "eti":"p", "class":"tit", "htm":"El <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/kin#_04-02-\'>Índice Armónico</a> en <cite>el Encantamiento del Sueño</cite>" },
          "atr-2": [ "des" ],
          "fic-2": [ "kin" ]
        }
      }' ),
      ...
      ('hol','kin_cro_est', '{
        ...
        "inf": {
          ...
          "htm-1": { "eti":"p", "class":"tit", "htm":"Las <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/kin#_03-01-\'>Etapas Evolutivas</a> del Ser Galáctico en <cite>el Factor Maya</cite>" },
          "atr-1": [ "fac_des" ],

          "htm-2": { "eti":"p", "class":"tit", "htm":"Los <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/kin#_03-02-\'>Elementos Galácticos</a> del Giro Espectral en <cite>el Encantamiento del Sueño</cite>" },
          "fic-2": [ "ele" ]
        }
      }' ),
      ('hol','kin_cro_est_dia', '{
      ...
      ('hol','kin_cro_ele', '{ 
        ...
        "inf": { 
          ...
          "htm-2": { "eti":"p", "class":"tit", "htm":"Los <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/kin#_03-01-\'>Kines del Giro Espectral</a>" },
          "fic-2": [ "kin" ]
        }
      }' ),
      ...
      ('hol','kin_nav_cas', '{ 
        ...
        "inf": {
          ...
          "htm": { "eti":"p", "class":"tit", "htm":"Las <n>20</n> <a target=\'_blank\' href=\'http://localhost//sincronario/codigo/kin#_05-02-\'>Ondas Encantadas</a> de la Nave del Tiempo" },
          "atr": [ "des" ],
          "fic": [ "nav_ond" ]
        }
      }' ),
      ('hol','kin_nav_ond', '{
        ...
        "opc": {
          "ima":[ "ide", "kin", "sel", "nav_cas", "cas_arm" ]
        },        
        "tab": {
          "pos": { "ima":"hol.kin.ide", "col": "", "num": "" },
          "val-par": 1,
    ...
    DELETE FROM `sis-dat_est` WHERE `esq` = 'hol' AND `ide` LIKE 'psi%'; INSERT INTO `sis-dat_est` VALUES
      ...
      ('hol','psi', '{
        ...
        "val": { 
          "nom": "Psi-Crono #()($)ide() de 364, día del Calendario ()($)fec().",
          "des": "Codificado por el Kin ()($)kin(), ()($)kin_nom(): ()($)kin_des().",
      ...
      ('hol','psi_ani', '{
        ...
        "val": {
          "nom": "Anillo Solar #()($)ide() de 52, año ()($)cod() del Ciclo Siriano.",
          "des": "Codificado por el kin ()($)fam_4(), ()($)kin_nom(): ()($)kin_des().",
          "ima": "background: top/50% no-repeat url(http://localhost/_img/hol/fic/ton/()($)kin_ton().png), bottom/60% no-repeat url(http://localhost/_img/hol/fic/sel/()($)kin_sel().png);",
          "col": 4        
        },
        "opc": {
      ...
      ('hol','psi_lun', '{
        ...
        "val": { 
          "nom": "Luna #()($)ide() de 13, ()($)nom(): ()($)fec_ran().",
          "des": "Codificada por el Tono ()($)ton_nom(): ()($)ton_des() del Giro Solar Anual; \\nTotem ()($)tot(): ()($)tot_pro()",
        ...
        "inf": {
          ...
          "htm-1": { "eti":"p", "class":"tit", "htm":"La <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/tono#_03-\'>Onda Encantada</a> de la Aventura" },
          "tex-1": "()($)ond_nom(): ()($)ond_pos().\\n()($)ond_pod(): ()($)ond_man().",

          "htm-2": { "eti":"p", "class":"tit", "htm":"El <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/psi#_01-01-\'>Totem Animal</a> de las 13 Lunas" },
      ...
      ('hol','psi_est', '{
        ...
        "val": { 
          "nom": "Estación Solar #()($)ide() de 4, ()($)nom(): ()($)fec_ran().",
        ...
        "inf": {
          ...
          "htm": { "eti":"p", "class":"tit", "htm":"Las <a target=\'_blank\' href=\'http://localhost/sincronario/codigo/psi#_01-02-\'>Estaciones Solares</a> del Anillo Solar" },
          "atr": "des",
          "dat": [ "pol_nor", "pol_sur" ]
        }
      }' ),
      ...
      ('hol','psi_hep', '{
        ...
        "val": { 
          "nom": "Heptada #()($)ide() de 52, ()($)nom(): ()($)fec_ran().",
          "des": "Codificada por el tono ()($)ton_nom(): ()($)des().",
      ...
      ('hol','psi_cro', '{
        ...
        "val": { 
          "nom": "Cromática Entonada #()($)ide() de 75: ()($)fec_ran().",        
          "num": 75
        },
        "opc": {
          "ima": [ "psi" ]
      ...
      ('hol','psi_vin', '{
        ...
        "val": { 
          "nom": "Vinal #()($)ide() de 19, ()($)nom(): ()($)fec_ran().",
          "des": "()($)des().",
          "num": 19
        },
        "opc": {
