...
--
-- Calendario
  DELETE FROM `api`.`app_dat` WHERE `esq` = 'api' AND `ide` LIKE 'fec_%'
  ;
  
  DELETE FROM `api`.`app_dat` WHERE `esq` = 'api' AND `ide` LIKE 'fec%';
  INSERT INTO `api`.`app_dat` VALUES
    -- fecha
    ( 'api', 'fec', '{
        "val": {
        },
...
--
-- Holon
  DELETE FROM `api`.`app_dat` WHERE `esq`='api' AND `ide` LIKE 'hol_%'
  ;
  DELETE FROM `api`.`app_dat` WHERE `esq`='api' AND `ide` LIKE 'hol_rad%'; INSERT INTO `api`.`app_dat` VALUES
  ...
  ;
  DELETE FROM `api`.`app_dat` WHERE `esq`='api' AND `ide` LIKE 'hol_ton%'; INSERT INTO `api`.`app_dat` VALUES
  ...
  ;
  DELETE FROM `api`.`app_dat` WHERE `esq`='api' AND `ide` LIKE 'hol_sel%'; INSERT INTO `api`.`app_dat` VALUES
  ...
  ;
  DELETE FROM `api`.`app_dat` WHERE `esq`='api' AND `ide` LIKE 'hol_lun%'; INSERT INTO `api`.`app_dat` VALUES
  ...
  ;
  DELETE FROM `api`.`app_dat` WHERE `esq`='api' AND `ide` LIKE 'hol_chi%'; INSERT INTO `api`.`app_dat` VALUES
  ...
  ;
  DELETE FROM `api`.`app_dat` WHERE `esq`='api' AND `ide` LIKE 'hol_psi%'; INSERT INTO `api`.`app_dat` VALUES
