...
-- tipos
  ...
  -- tipo de dato 
  DELETE FROM `dat_tip_dat`;
  INSERT INTO `dat_tip_dat` (`ide`,`nom`,`des`,`ope`) VALUES
  ...
  -- tipo de valor 
  DELETE FROM `dat_tip_val`;
  INSERT INTO `dat_tip_val` (`dat`,`ide`,`nom`,`des`,`len`,`ope`) VALUES
...
-- Operaciones
  DELETE FROM `dat_ope`;
  INSERT INTO `dat_ope` (`tip`,`dat`,`ide`,`pos`,`nom`,`des`) VALUES
