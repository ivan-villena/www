...
-- HOLON
  DELETE FROM `_api`.`dat_val` WHERE `esq`='hol';

  -- x7 : plasma radial
  DELETE FROM `_api`.`dat_val` WHERE `esq`='hol' AND `est` LIKE 'rad%';
  ...
  ;
  -- x13 : tono galáctico
  DELETE FROM `_api`.`dat_val` WHERE `esq`='hol' AND `est` LIKE 'ton%';
  INSERT INTO `_api`.`dat_val` VALUES
  ...
  ;
  -- x 20 : sello solar
  DELETE FROM `_api`.`dat_val` WHERE `esq`='hol' AND `est` LIKE 'sel%';
  INSERT INTO `_api`.`dat_val` VALUES
      -- datos
      ( 'hol', 'sel', '{
  ...
  ;
  -- x28 : giro lunar
  DELETE FROM `_api`.`dat_val` WHERE `esq`='hol' AND `est` LIKE 'lun%';
  INSERT INTO `_api`.`dat_val` VALUES
  ...
  ;
  -- x52 : castillo del fractal-g
  DELETE FROM `_api`.`dat_val` WHERE `esq`='hol' AND `est` LIKE 'cas%';
  INSERT INTO `_api`.`dat_val` VALUES
  ...
  ;
  -- x64: hexagramas del i-ching
  DELETE FROM `_api`.`dat_val` WHERE `esq`='hol' AND `est` LIKE 'chi%';
  INSERT INTO `_api`.`dat_val` VALUES
  ...
  ;
  -- x260: tzolkin
  DELETE FROM `_api`.`dat_val` WHERE `esq`='hol' AND `est` LIKE 'kin%';
  INSERT INTO `_api`.`dat_val` VALUES
  ...
  ;
  -- x365 : banco-psi
  DELETE FROM `_api`.`dat_val` WHERE `esq`='hol' AND `est` LIKE 'psi%';
  INSERT INTO `_api`.`dat_val` VALUES
