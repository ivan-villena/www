...
<article>
  <h2 id="_01-"><?=tex::let($_nav[1]['01']->nom)?></h2>
  ...
  <figure>
    <img src='<?=$_dir->ima?>01-01.png' class='mar-1'>
  ...
  foreach( hol::_($ide = 'lun_arm') as $_hep ){ $_ []= 
    tex::let("$_hep->nom (")."<c class='let_col-4-$_hep->ide'>$_hep->col</c>".tex::let("): $_hep->des");
  }
  echo dat::lis($_,$ide,"val");
  ?>

  <figure>
    <img src='<?=$_dir->ima?>01-02.jpg' class='mar-1'>
  ...
  <figure>
    <img src='<?=$_dir->ima?>01-03.png' class='mar-1'>
...
<article>
  <h2 id="_02-"><?=tex::let($_nav[1]['02']->nom)?></h2>
  ...
  <figure>
    <img src='<?=$_dir->ima?>02-01.png' class='mar-1'>
    <figcaption>
  ...
  <figure>
    <ul class="ope mar-aut">
      <li><?=hol::ima('kin','001',['class'=>"mar_der-1"])?></li>
      <li><?=hol::ima('kin','002',['class'=>"mar_der-1"])?></li>
      <li><?=hol::ima('kin','003',['class'=>"mar_der-1"])?></li>
      <li><?=hol::ima('kin','004',['class'=>"mar_der-1"])?></li>
      <li><?=hol::ima('kin','005',['class'=>"mar_der-1"])?></li>
    </ul>
...
<article>
  ...
  <h3 id="_03-01-"><?=tex::let($_nav[2]['03']['01']->nom)?></h3>
  <section>

    <figure>
      <img src='<?=$_dir->ima?>03-01-01.png' class='mar-aut'>        
    </figure>
    ...
    <div class="ite">
      ...
      <?=dat::lis_des('hol','rad',['pla_ene','pla_pod'])?>
  ...
  <h3 id="_03-02-"><?=tex::let($_nav[2]['03']['02']->nom)?></h3>
  <section>

    <figure>
      <img src='<?=$_dir->ima?>03-02-01.png' class='mar-1'>        
    </figure>      
    ...
    Para tener más información sobre el tiempo galáctico ver Boletín Rinri <c>"</c><a href="https://www.13lunas.net/boletines/Rinri/V03N2_2.htm" target="_blank">Recordando el Camino Sagrado <c>-</c> Tiempo Estándar Galáctico <c>(</c>TEG<c>)</c><c>:</c> El significado esencial del Sincronario de Trece Lunas de <n>28</n> días</a><c>"</c> <c>(</c>Rinri III <n>2<c>.</c>2</n><c>)</c>
    
  </section>
  
  <h3 id="_03-03-"><?=tex::let($_nav[2]['03']['03']->nom)?></h3>
  <section>

    <figure>
      <img src='<?=$_dir->ima?>03-03-01.png' class='mar-1'>        
    </figure>      
  ...
  <h3 id="_03-04-"><?=tex::let($_nav[2]['03']['04']->nom)?></h3>
  <section>

    <figure>
      <img src='<?=$_dir->ima?>03-04-01.png' class='mar-1'>        
    </figure>
  ...
  <h3 id="_03-05-"><?=tex::let($_nav[2]['03']['05']->nom)?></h3>
  <section>

    <figure>
      <img src='<?=$_dir->ima?>03-05-01.png' class='mar-1'>
    </figure>
...
<article>
  <h2 id="_04-"><?=tex::let($_nav[1]['04']->nom)?></h2>
  ...
  <section>
    <h3 id="_04-01-"><?=tex::let($_nav[2]['04']['01']->nom)?></h3>
  ...
  <section>
    <h3 id="_04-02-"><?=tex::let($_nav[2]['04']['02']->nom)?></h3>
  ...
  <section>
    <h3 id="_04-03-"><?=tex::let($_nav[2]['04']['03']->nom)?></h3>
    ...
    <figure>
      <img src='<?=$_dir->ima?>04-03.png' class='mar-1'>
    </figure>
  ...
  <section>
    <h3 id="_04-04-"><?=tex::let($_nav[2]['04']['04']->nom)?></h3>
    ...
    <figure>
      <img src='<?=$_dir->ima?>04-04.png' class='mar-1'>
    </figure>
...
<article>
  <h2 id="_05-"><?=tex::let($_nav[1]['05']->nom)?></h2>
  ...
  <figure>
    <a href="http://www.13lunas.net/fechafirmaGalacticaBasica.html" target="_blank"><img src='<?=$_dir->ima?>05.png' class='mar-1'></a>        
  </figure>            
