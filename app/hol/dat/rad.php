...
<?php 
  ...
  <article>
    ...
    <?=api_est::lis('hol.rad',[ 'atr'=>['ide','nom','des_pod'] ])?>
  ...
  <article>
    ...
    <?=api_est::lis('hol.rad',[ 'atr'=>['ide','tel','tel_año','tel_des','tel_ora_año','tel_ora_ani','tel_ora_gen'] ])?>
    ...
    <?=api_est::lis('hol.rad',[ 'atr'=>['ide','tel_año','rin_des'], 'opc'=>["cab_ocu"] ])?>
  ...
  <article>
    ...
    <?=api_est::lis('hol.rad',[ 'atr'=>['ide','des_col','pla_des','pla_fue'], 'opc'=>["cab_ocu"] ])?>
    ...
    <section>
      ...
      <?=api_est::lis('hol.rad_pla_fue',[ 'atr'=>['ide','nom','ele_pre','ele_ope','ele_pos'], 'opc'=>["cab_ocu"] ])?>            
    ...
    <section>
      ...
      <?=api_est::lis('hol.rad_pla_ele',[ 'atr'=>['ide','nom','des'], 'opc'=>["cab_ocu"] ])?>      
    ...
    <section>
      ...
      <?=api_est::lis('hol.rad_pla_qua',[ 'atr'=>['ide','nom','lec_col','pla'], 'opc'=>["cab_ocu"] ])?>
  ...
  <article>
    ...
    <?=api_est::lis('hol.rad',[ 'atr'=>['ide','pla_lec'], 'opc'=>["cab_ocu"] ])?>
  ...
  <article>
    ...
    <?=api_est::lis('hol.rad',[ 'atr'=>['ide','pla_cub_pos','pla_cub','hum_cha'], 'opc'=>["cab_ocu"] ])?>
