...
<?php 
  ...
  <article>
    ...
    <?=api_lis::est('hol.sel',[ 'atr'=>[ 'ide','nom_may' ] ])?>
    ...
    <section>
      ...
      <p>En <cite>el Factor Maya</cite> se relacionan los Signos con <a href="<?=$_bib?>fac#_04-04-02-03-" target="_blank">Direcciones Específicas</a> que van en sentido contrario a las manecillas del reloj<c>.</c><c>.</c> Esto crea una relación de reciprocidad así como con los <n>13</n> números y la <i>Simetría Especular</i><c>.</c></p>

      <?=api_lis::est('hol.sel_cic_dir',[ 'atr'=>[ 'ide','nom','des_col','des','sel' ] ])?>
    ...
    <section>
      ...
      <p>En <cite>el Factor Maya</cite> se organizan los <n>20</n> Signos en <a href="<?=$_bib?>fac#_04-04-02-05-" target="_blank">Grupos de Ruedas Radiales</a> cada una <q>girando en sentido contrario a las manecillas del reloj<c>,</c> desde el Oriente hacia el Norte<c>,</c> Oeste<c>,</c> y al Sur</q><c>,</c> forman un modelo mandálico donde cada rueda es un fractal u holograma de la progresión completa<c>.</c> Estos grupos funcionan como <i>Engranajes de la Memoria</i> y son llamados <i>Familias Cíclicas</i><c>.</c></p>

      <?=api_lis::est('hol.sel',[ 'atr'=>['ide','nom_may','cic_dir','cic_luz_des'], 'tit_cic'=>['cic_luz'], 'opc'=>['cab_ocu'] ])?>
    ...
    <section>
      ...
      <?=api_lis::est('hol.kin_cro_est',[ 'atr'=>['sel','nom','des_dir','fac_des'] ])?>
      ...
      <?=api_lis::est('hol.kin_cro_ond')?>

    </section>
    
  </article>

  <!-- Arquetipos del Kin planetario  -->
  <article>
    <?php $nv1 = api_num::val(intval($nv1) + 1,2); $nv2 = 0; $nv3 = 0; $nv4 = 0; ?>
    <h2 id="<?="_{$_nav[1][$nv1]->pos}-"?>"><?=api_tex::let($_nav[1][$nv1]->nom)?></h2>
    ...
    <!-- Parejas del oráculo -->
    <p>En <cite>el Encantamiento del Sueño</cite> <a href="<?=$_bib?>enc#_02-03-06-" target="_blank">...</a><c>.</c></p>
    ...
    <section>
      ...
      <?=api_lis::est('hol.sel_par_ana',[ 'atr'=>['ini','ini_car','ini_des','fin','fin_car','fin_des'] ])?>
    ...
    <section>
      ...
      <?=api_lis::est('hol.sel_par_ant',[ 'atr'=>['ini','ini_car','ini_des','fin','fin_car','fin_des'] ])?>
    ...
    <section>
      ...
      <?=api_lis::est('hol.sel_par_ocu',[ 'atr'=>['ini','ini_car','ini_des','fin','fin_car','fin_des'] ])?>
