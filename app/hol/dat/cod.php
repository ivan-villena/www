...
<div>
  ...
  <section>
    ...
    <!-- dìas de la semana -->
    <article>
      <h3 id="<?="_{$_nav[2]['07']['01']->pos}-"?>"><?=api_tex::let($_nav[2]['07']['01']->nom)?></h3>
    ...
    <article>          
      <h3 id="<?="_{$_nav[2]['07']['02']->pos}-"?>"><?=api_tex::let($_nav[2]['07']['02']->nom)?></h3>
      ...
      <?=api_lis::est('hol.rad',[ 'atr'=>['ide','tel','tel_des','tel_año','tel_ora_año','tel_ora_ani','tel_ora_gen'] ])?>
      ...
      <?=api_lis::est('hol.rad',[ 'atr'=>['ide','tel_des','tel_año','rin_des'] ])?>

    </article>
    <!-- heptágono de la mente -->
    <article>
      <h3 id="<?="_{$_nav[2]['07']['03']->pos}-"?>"><?=api_tex::let($_nav[2]['07']['03']->nom)?></h3>
      ...
      <?=api_lis::est('hol.rad',[ 'atr'=>['ide','nom','pla_cub','pla_cub_pos'] ])?>

    </article>
    <!-- autodeclaraciones diarias -->
    <article>
      <h3 id="<?="_{$_nav[2]['07']['04']->pos}-"?>"><?=api_tex::let($_nav[2]['07']['04']->nom)?></h3>
      ...
      <?=api_lis::est('hol.rad',[ 'atr'=>['ide','nom','hum_cha','cha_nom','pla_lec'] ])?>

    </article>
    <!-- componenetes electrónicos -->
    <article>
      <h3 id="<?="_{$_nav[2]['07']['05']->pos}-"?>"><?=api_tex::let($_nav[2]['07']['05']->nom)?></h3>
      ...
      <?=api_lis::est('hol.rad',[ 'atr'=>['ide','nom','col','pla_qua','pla_pod','pla_fue','pla_fue_pre','pla_fue_pos'] ])?>
  ...
  <section>
    ...
    <!-- rayos de pulsación -->
    <article>
      <h3 id="<?="_{$_nav[2]['13']['01']->pos}-"?>"><?=api_tex::let($_nav[2]['13']['01']->nom)?></h3>
    ...
    <!-- simetría especular -->
    <article>
      <h3 id="<?="_{$_nav[2]['13']['02']->pos}-"?>"><?=api_tex::let($_nav[2]['13']['02']->nom)?></h3>
    ...
    <article>
      <h3 id="<?="_{$_nav[2]['13']['03']->pos}-"?>"><?=api_tex::let($_nav[2]['13']['03']->nom)?></h3>
    ...
    <!-- O.E. de la Aventura -->
    <article>
      <h3 id="<?="_{$_nav[2]['13']['04']->pos}-"?>"><?=api_tex::let($_nav[2]['13']['04']->nom)?></h3>
    ...
    <!-- pulsar dimensional -->
    <article>
      <h3 id="<?="_{$_nav[2]['13']['05']->pos}-"?>"><?=api_tex::let($_nav[2]['13']['05']->nom)?></h3>
      <p>En <cite>el Encantamiento del sueño</cite> <a href="<?=$_bib?>enc#_03-13-" target="_blank"></a> <c>.</c></p>
      <?=api_lis::est('hol.ton_dim')?>
    </article>
    <!-- pulsar matiz -->
    <article>
      <h3 id="<?="_{$_nav[2]['13']['06']->pos}-"?>"><?=api_tex::let($_nav[2]['13']['06']->nom)?></h3>
  ...
  <section>
    ...
    <article>
      <h3 id="<?="_{$_nav[2]['20']['01']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['01']->nom)?></h3>
      <p>En <a href="<?=$_bib?>fac#_04-04-02-03-" target="_blank">el Factor maya</a><c>.</c></p>
      <?=api_lis::est('hol.sel_cic_dir')?>
    </article>
    <!-- 3 etapas del desarrollo -->
    <article>
      <h3 id="<?="_{$_nav[2]['20']['02']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['02']->nom)?></h3>
    ...
    <!-- 4 etapas evolutivas -->
    <article>
      <h3 id="<?="_{$_nav[2]['20']['03']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['03']->nom)?></h3>
    ...
    <!-- 5 familias ciclicas -->
    <article>
      <h3 id="<?="_{$_nav[2]['20']['04']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['04']->nom)?></h3>
    ...
    <article>
      <h3 id="<?="_{$_nav[2]['20']['05']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['05']->nom)?></h3>          
    ...
    <article>
      <h3 id="<?="_{$_nav[2]['20']['06']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['06']->nom)?></h3>
    ...
    <!-- 4 clanes cromáticos -->
    <article>
      <h3 id="<?="_{$_nav[2]['20']['07']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['07']->nom)?></h3>
    ...
    <!-- Colocación armónica -->
    <article>
      <h3 id="<?="_{$_nav[2]['20']['08']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['08']->nom)?></h3>
    ...
    <article>
      <h3 id="<?="_{$_nav[2]['20']['09']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['09']->nom)?></h3>
    ...
    <!-- células del tiempo-->
    <article>
      <h3 id="<?="_{$_nav[2]['20']['10']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['10']->nom)?></h3>
    ...
    <!-- parejas del oráculo -->
    <article>
      <h3 id="<?="_{$_nav[2]['20']['11']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['11']->nom)?></h3>
    ...
    <article>
      <h3 id="<?="_{$_nav[2]['20']['18']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['18']->nom)?></h3>
      <p>En <a href="<?=$_bib?>tel" target="_blank">Telektonon</a><c>.</c></p>
      <?=api_lis::est('hol.uni_sol_cir')?>
    </article>             
    <!-- holon planetario -->
    <article>
      <h3 id="<?="_{$_nav[2]['20']['19']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['19']->nom)?></h3>
    ...
    <article>
      <h3 id="<?="_{$_nav[2]['20']['20']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['20']->nom)?></h3>
      <p></p>
    </article>          
    <!-- centros galácticos -->        
    <article>
      <h3 id="<?="_{$_nav[2]['20']['21']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['21']->nom)?></h3>
      <p></p>
      <?=api_lis::est('hol.uni_pla_cen')?>
    </article>
    <!-- flujos de la fuerza-g -->        
    <article>
      <h3 id="<?="_{$_nav[2]['20']['22']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['22']->nom)?></h3>
      <p>En <a href="<?=$_bib?>enc#_03-16-" target="_blank">el Encantamiento del Sueño</a><c>.</c></p>
      <?=api_lis::est('hol.uni_pla_res')?>
    </article>        
    <!-- holon humano -->
    <article>
      <h3 id="<?="_{$_nav[2]['20']['23']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['23']->nom)?></h3>
    ...
    <!-- Centros Galácticos -->        
    <article>
      <h3 id="<?="_{$_nav[2]['20']['24']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['24']->nom)?></h3>
      <?=api_lis::est('hol.uni_hum_cen')?>
    </article>
    <!-- Extremidades -->        
    <article>
      <h3 id="<?="_{$_nav[2]['20']['25']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['25']->nom)?></h3>
      <?=api_lis::est('hol.uni_hum_ext')?>
    </article>                     
    <!-- dedos -->        
    <article>            
      <h3 id="<?="_{$_nav[2]['20']['26']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['26']->nom)?></h3>
      <?=api_lis::est('hol.uni_hum_ded')?>
    </article>
    <!-- lados -->        
    <article>
      <h3 id="<?="_{$_nav[2]['20']['27']->pos}-"?>"><?=api_tex::let($_nav[2]['20']['27']->nom)?></h3>
  ...
  <!-- 28 Días Lunares -->
  <section>
    <h2 id="<?="_{$_nav[1]['28']->pos}-"?>"><?=api_tex::let($_nav[1]['28']->nom)?></h2>

    <!-- días -->
    <article>    
      <p>En <a href="<?=$_bib?>" target="_blank">el Encantamiento del Sueño</a><c>.</c></p>
      <?=api_lis::est('hol.lun',[ 'atr'=>['ide','arm','rad','ato_des'] ])?> 
    </article>  
    
    <!-- 4 heptadas -->
    <article>          
      <h3 id="<?="_{$_nav[2]['28']['01']->pos}-"?>"><?=api_tex::let($_nav[2]['28']['01']->nom)?></h3>
  ...
  <section>
    <h2 id="<?="_{$_nav[1]['52']->pos}-"?>"><?=api_tex::let($_nav[1]['52']->nom)?></h2>

    <article>
      <h3 id="<?="_{$_nav[2]['52']['01']->pos}-"?>"><?=api_tex::let($_nav[2]['52']['01']->nom)?></h3>
  ...
  <!-- 64 Hexagramas -->
  <section>
    <h2 id="<?="_{$_nav[1]['64']->pos}-"?>"><?=api_tex::let($_nav[1]['64']->nom)?></h2>

    <article>
      <h3 id="<?="_{$_nav[2]['64']['01']->pos}-"?>"><?=api_tex::let($_nav[2]['64']['01']->nom)?></h3>
  ...
  <section>
    <h2 id="<?="_{$_nav[1]['260']->pos}-"?>"><?=api_tex::let($_nav[1]['260']->nom)?></h2>

    <article>
      <h3 id="<?="_{$_nav[2]['260']['01']->pos}-"?>"><?=api_tex::let($_nav[2]['260']['01']->nom)?></h3>
  ...
  <section>
    <h2 id="<?="_{$_nav[1]['365']->pos}-"?>"><?=api_tex::let($_nav[1]['365']->nom)?></h2>

    <article>
      <h3 id="<?="_{$_nav[2]['365']['01']->pos}-"?>"><?=api_tex::let($_nav[2]['365']['01']->nom)?></h3>
...
<?php
$sis_app->ope['app_dat']['htm'] = ob_get_clean();    