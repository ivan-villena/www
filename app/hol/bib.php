...
class hol_bib {
  ...
  static function asc( string $ide, array $ope = [] ) : string {
    ...
    return is_array($_) ? api_dat::lis( $_, $ide, $ope ) : $_;
  }
  // Factor Maya
        ...
        foreach( ( !empty($dat) ? $dat : api_hol::_('kin') ) as $_kin ){
          ...
          if( $ond != $_kin->nav_ond ){
            ...
            <tr class='tex_ali-izq'>
              ...
              <td colspan='3'>{$_sel->nom_may}<c>:</c> ".api_tex::let($_ond->fac)." <q>".api_tex::let($_ond->fac_des)."</q></td>
            </tr>";
          }
  ...
  static function enc( string $ide, array $ope = [] ) : string {
    ...
    case 'sel_arm_raz':
      ...
      foreach( api_hol::_($ide) as $_dat ){
        ...
        foreach( api_hol::_('sel_arm_cel') as $lis_pos ){
          ...
          <li>
            ...
            <p>
              ...
              <br><q>".api_tex::let($_sel->arm_raz_des)."</q>
            </p>
          </li>";
          $sel += 4;
          if( $sel > 20 ) $sel -= 20;                  
        ...
        <q>".api_tex::let(api_tex::let_pal($_raz_pod)." ha sido ".api_tex::art_gen("realizado",$_raz_pod).".")."</q>";
        $_ []= $htm;
        $sel++;
      }        
      break;
        ...
        foreach( api_hol::_('sel_arm_raz') as $cro ){ $_sel = api_hol::_('sel',$lis_pos); $htm .= "
          <li>
            ...
            <p>
              ...
              <br><q>".api_tex::let($_sel->arm_cel_des)."</q>
            </p>
          </li>";
          $lis_pos ++;
        }$htm .= "
    ...
    case 'sel_cro_ele':
      ...
      foreach( api_hol::_($ide) as $_dat ){
        ...
        <p class='tit'><b class='ide'>Clan ".api_tex::art_del($_dat->nom)."</b>".api_tex::let(": Cromática {$_dat->des_col}.")."</p>
        ".( !empty($_dat->des_ini) ? "<p>".api_tex::let($_dat->des_ini)."</p>" : '' )."
        <ul class='ite'>";
        for( $fam=1; $fam<=5; $fam++ ){ 
          ...
          <li sel='{$_sel->ide}' cro_fam='{$fam}'>
            ...
            <p>
              ...
              <br><q>".api_tex::let($_sel->cro_ele_des)."</q>
            </p>
          </li>";
          $sel++;
          if( $sel > 20 ) $sel -= 20;
    ...
    case 'uni_hum_cen':
      ...
      foreach( api_hol::_($ide) as $_dat ){
        ...
        <p><b class='ide'>Kin {$_fam->nom}</b><c>:</c> <b class='val'>{$_fam->des_cod}</b>
          <br>".api_tex::art($_dat->nom)." <c>-></c> {$_hum->des_pod}
        </p>";
      }            
      break;
      ...
      <form class='doc_inf' esq='hol' est='$ide'>
        ...
        <div class='doc_val'>
          ...
          <fieldset class='doc_ope'>
            ".api_fig::ico('dat_fin',[ 'eti'=>"button", 'type'=>"reset", 'title'=>"Vaciar Casillero...", 'onclick'=>"{$_eje}this,'fin');" ])."
            ".api_fig::ico('lis_fin',[ 'eti'=>"button", 'title'=>"Ir al Kin...", 'onclick'=>"{$_eje}this,'nav');" ])."
          </fieldset>
    ...
    case 'kin_nav':
      ...
      foreach( api_hol::_('kin_nav_ond') as $_ond ){
        ...
        <p><n>".intval($_ond->ide)."</n><c>°</c> Onda encantada<c>:</c> <q>".api_tex::let($_ond->enc_des)."</q></p>";
      }          
      break;
  ...
  static function rin( string $ide, array $ope = [] ) : string {
    ...
    case 'lun_cub':
      foreach( api_hol::_($ide) as $_cub ){
        ...
        ".( !empty($_cub->lec) ? "<p class='tex-cur tex_ali-cen'>".api_tex::let($_cub->lec)."</p>" : ""  )."
        <q>".api_tex::let($_cub->afi)."</q>";
      }        
      break;                    
  ...
  static function ato( string $ide, array $ope = [] ) : string {
    ...
    case 'rad_pla':
      ...
      case 'fue':
        foreach( api_hol::_($dat_ide) as $rad ){
          $fue_pre = api_hol::_($dat_rel,$rad->pla_fue_pre);
          $fue_pos = api_hol::_($dat_rel,$rad->pla_fue_pos);
          $_ []= 
          ...
          <div>        
            ...
            <div class='doc_ite'>
              ...
              <p><c class='sep'>:</c> ".api_tex::let($rad->pla_fue)." <c>(</c>Días ".api_tex::let($rad->dia)."<c>)</c></p>
            </div>
          </div>";
      ...
      case 'des': 
        foreach( api_hol::_($ide) as $rad ){
          ...
          <p>
            ".api_tex::let("$rad->nom: $rad->pla_des.")."
            <br>
            <q>".api_tex::let($rad->pla_lec)."</q>
          </p>";            
          if( in_array($rad->ide,$pla_qua) ){
            $qua = api_hol::_('rad_pla_qua',$rad->pla_qua);
            $_ []= 
            api_hol::ima('rad_pla_qua',$qua,['class'=>"mar_der-2"]).
            "<p>".api_tex::let($qua->pla_des)."</p>";
          }
        }
        break;
      ...
      case 'cub':
        ...
        foreach( api_hol::_($ide) as $rad ){
          ...
          <div>
            <p>".api_tex::let("$rad->nom (Días $rad->dia): $cha->pos Chakra, $cha->des_cod o $cha->nom")."</p>
    ...
    case 'rad_pla_ele': 
      ...
      foreach( api_hol::_($ide) as $pla_ele ){
        ...
        <p>
          <b class='ide'>$pla_ele->nom</b> o <b class='ide'>$pla_ele->nom_cod</b>
          <br>
    ...
    case 'lun_pla_ato':
      ...
      case 'tie': 
        ...
        api_fig::ima('hol/ima/lun',['class'=>"mar_der-2 tam-15"])."
      ...
      foreach( api_hol::_($ide) as $tie ){
        ...
        <div class='doc_ite'>
          ...
          <p>
            ...
            <br>".api_tex::let("Plasma Radial $rad->ide, $rad->nom: $rad->pla_fue")."
