...
<div class="tex_bib">
  ...
  <article>
    <h2 id="_01-"><?=api_tex::let($_nav[1]['01']->nom)?></h2>
  ...
  <article>
    <h2 id="_02-"><?=api_tex::let($_nav[1]['02']->nom)?></h2>
  ...
  <article>
    <h2 id="_03-"><?=api_tex::let($_nav[1]['03']->nom)?></h2>
    ...
    <h3 id="_03-01-"><?=api_tex::let($_nav[2]['03']['01']->nom)?></h3>
    <section>
      ...
      <div class="ite">
        ...
        <?=api_dat::lis_des('hol','rad',['pla_des'])?>
      ...
      <div class="ite">
        ...
        <?=api_dat::lis_des('hol','rad',['pla_ene','pla_pod'])?>
    ...
    <h3 id="_03-02-"><?=api_tex::let($_nav[2]['03']['02']->nom)?></h3>
    <section>
    ...
    <h3 id="_03-03-"><?=api_tex::let($_nav[2]['03']['03']->nom)?></h3>
    <section>
    ...
    <h3 id="_03-04-"><?=api_tex::let($_nav[2]['03']['04']->nom)?></h3>
    <section>
      ...
      <?=api_lis::est("hol.ton",['atr'=>['ide','nom','des_car','des_pod','des_acc'],'opc'=>['htm','cab_ocu']])?>

      <h4>Los <n>20</n> Sellos Solares</h4>

      <?=api_lis::est("hol.sel",['atr'=>['ide','nom','des_pod','des_acc','des_car'],'opc'=>['htm','cab_ocu']])?>
    ...
    <h3 id="_03-05-"><?=api_tex::let($_nav[2]['03']['05']->nom)?></h3>
    <section>
  ...
  <article>
    <h2 id="_04-"><?=api_tex::let($_nav[1]['04']->nom)?></h2>
    ...
    <section>
      <h3 id="_04-01-"><?=api_tex::let($_nav[2]['04']['01']->nom)?></h3>
    ...
    <section>
      <h3 id="_04-02-"><?=api_tex::let($_nav[2]['04']['02']->nom)?></h3>
    ...
    <section>
      <h3 id="_04-03-"><?=api_tex::let($_nav[2]['04']['03']->nom)?></h3>
    ...
    <section>
      <h3 id="_04-04-"><?=api_tex::let($_nav[2]['04']['04']->nom)?></h3>
  ...
  <article>
    <h2 id="_05-"><?=api_tex::let($_nav[1]['05']->nom)?></h2>
