  ...
  static function tab( string $est, string $atr, array $ope = [], array $ele = [] ) : string {
    ...
    case 'kin': 
      ...
      case 'nav':
        ...
        <ul".ele::atr($ele['sec']).">";
          ...
          foreach( hol::_('kin_nav_cas') as $cas => $_cas ){
            $ope['ide'] = $_cas->ide;
            $ele['cas'] = $ele_cas;
            ele::cla($ele['cas'],"pos ide-$_cas->ide",'ini');
      ...
      case 'nav_cas':
        ...
        <ul".ele::atr($ele['cas']).">";
          $ele_ite = isset($ele['pos-00']) ? $ele['pos-00'] : [];
          ele::cla($ele_ite,"pos ide-0 bor_col-5-{$ide} fon_col-5-{$ide}");
          $_ .= "
      ...
      case 'arm':
        ...
        <ul".ele::atr($ele['sec']).">
          ...
          foreach( hol::_('kin_arm_tra') as $_tra ){ 
            $ope['ide'] = $_tra->ide;
            $ele['tra'] = $ele_tra;
            ele::cla($ele['tra'],"pos ide-{$_tra->ide}",'ini');
      ...
      case 'arm_cel': 
        ...
        <ul".ele::atr($ele['cel']).">";
          ...
          ele::cla($ele_ite,"pos ide-0 col-bla",'ini');
      ...
      case 'cro': 
        ...
        <ul".ele::atr($ele['sec']).">";
          ...
          foreach( hol::_('kin_cro_ele') as $_ele ){
            $ope['ide'] = $_ele->ide;
            $ele['ele'] = $ele_ele;
            ele::cla($ele['ele'],"pos ide-{$_ele->ide}");
      ...
      case 'ban': 
        ...
        <ul".ele::atr($ele['sec']).">
          ...
          foreach( hol::_('psi_lun') as $_lun ){            
            ...
            ele::cla($ele_pos,"pos ide-$_lun->ide",'ini');
            $ope['ide'] = $_lun->ide; $_ .= "
            <li".ele::atr($ele_pos).">
      ...
      case 'ani':
        ...
        <ul".ele::atr($ele['sec']).">
          ...
          foreach( hol::_('cas') as $_cas ){
            $_kin = hol::_('kin',$kin);
            $ele_pos = $ele['pos'];
            ele::cla($ele_pos,"pos ide-".intval($_cas->ide),'ini');
            $_ .= "
            <li".ele::atr($ele_pos).">
              ".hol::ima("kin",$_kin)."
            </li>";
