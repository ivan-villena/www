--
-- Aplicacion
  DELETE FROM `doc_var` WHERE `esq`='app';
  -- Valores
  DELETE FROM `doc_var` WHERE `esq`='app' AND `dat`='val';
  INSERT INTO `doc_var` VALUES 
    -- 
  ...
  ;
  -- Estructura
  DELETE FROM `doc_var` WHERE `esq`='app' AND `dat`='est';
  INSERT INTO `doc_var` VALUES
    --
  ...
  ;
  -- Tablero
  DELETE FROM `doc_var` WHERE `esq`='app' AND `dat`='tab';
  INSERT INTO `doc_var` VALUES
    --
...
--
-- Holon
  DELETE FROM `doc_var` WHERE `esq`='hol';
  -- Valores
  DELETE FROM `doc_var` WHERE `esq`='hol' AND `dat` = 'val';
  INSERT INTO `doc_var` VALUES
  ...
  DELETE FROM `doc_var` WHERE `esq`='hol' AND `dat` = 'atr';
  INSERT INTO `doc_var` VALUES
    ...
    -- Portales de Activación
      ...
      ('hol','atr','pag', 2, 'kin', '{
        ...
        "ope":{ "tip":"opc_bin" },
        "htm_fin":{ "eti":"span", "htm":[ { "_let":"(" }, { "tip":"num", "val":"0" }, { "_let":")" } ] }
      }'),
      ('hol','atr','pag', 3, 'psi', '{
        "nom":"¿Giro Solar?",
  ...
  DELETE FROM `doc_var` WHERE `esq`='hol' AND `dat` = 'tab'
  ;-- por secciones
  DELETE FROM `doc_var` WHERE `esq`='hol' AND `dat` = 'tab' AND `val` = 'sec';
  INSERT INTO `doc_var` VALUES
  ...
  ;-- por opciones
  DELETE FROM `doc_var` WHERE `esq`='hol' AND `dat` = 'tab' AND `val` = 'atr';
  INSERT INTO `doc_var` VALUES
