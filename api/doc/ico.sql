...
--
-- estilo 
  DELETE FROM `doc_ico_gru`
  ;
  INSERT INTO `doc_ico_gru` VALUES
...
-- icono 
  ...
  -- 
  -- por aplicacion
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'app%';
    INSERT INTO `doc_ico` VALUES  
      ('app',         'home'),      
    ...
    ;
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'usu%';
    INSERT INTO `doc_ico` VALUES
      ('usu',	    'person'),      
      ('usu_pas',	'password'),
      ...
      ('usu_age',	'menu_book')
    ;
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'dat%';
    INSERT INTO `doc_ico` VALUES
      ...
      ('dat_eli',	'delete')
    ;    
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'val%';
    INSERT INTO `doc_ico` VALUES
  ...
  --
  -- por tipos
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'tab%';
    INSERT INTO `doc_ico` VALUES
      ('tab',  'dataset'),
      ('tab_sec',  ''),
      ('tab_pos',  ''),
      ...
      ('tab_val',  '')
    ;    
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'est%';
    INSERT INTO `doc_ico` VALUES
      ('est',	     'table_view'),
      ('est_dat',	 ''),
      ('est_atr',	 ''),
      ...
      ('est_val',	 '')
    ;    
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'lis%';
    INSERT INTO `doc_ico` VALUES
      ...
      ('lis_mov',	'unfold_more')
    ;
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'opc%';
    INSERT INTO `doc_ico` VALUES
    ...
    ;    
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'num%';
    INSERT INTO `doc_ico` VALUES
      ...
      ('num_adi',	'functions')
    ;
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'tex%';
    INSERT INTO `doc_ico` VALUES    
    ...
    ;
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'fec%';
    INSERT INTO `doc_ico` VALUES
    ...
    ;
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'fig%';
    INSERT INTO `doc_ico` VALUES
      ('fig',	'auto_graph'),      
      -- valores
      ('fig_col',	'palette'),
      ...
      ('fig_pol',	'polyline')
    ;
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'arc%';
    INSERT INTO `doc_ico` VALUES  
    ...
    ;
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'eje%';
    INSERT INTO `doc_ico` VALUES

      ('eje',	    'terminal')
    ;
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'obj%';
    INSERT INTO `doc_ico` VALUES
      ...
      ('obj_atr',	'data_object')
    ;
    DELETE FROM `doc_ico` WHERE `ide` LIKE 'ele%';
    INSERT INTO `doc_ico` VALUES      
      ('ele', 'code'),
      -- valores
      ('ele_htm', 'html'),
