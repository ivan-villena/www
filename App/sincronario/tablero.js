...
class dat_tab {
  ...
  static atr( $ide ){
    ...
    case 'pul':
      ...
      Doc.act('cla_agr',$Doc.Dat.tab.val.querySelectorAll(`.sec.pul[class*="${$.pul_ide}-"]:not(.${DIS_OCU})`),DIS_OCU);
      ...
      if( $var.checked && ( $.pos = $Doc.Dat.tab.val.querySelector(`${$Doc.Dat.tab.cla}[hol-kin="${$.kin}"]`) ) ){
        ...
        if( $.val ){
          ...
          // muestro pulsares
          Doc.act('cla_eli',$Doc.Dat.tab.val.querySelectorAll(`.sec.pul[class*="${$.pul_ide}-${$.ton_pul}"]`),DIS_OCU);
        }
      }
    ...
    case 'sim':
      ...
      Doc.act('cla_agr',$Doc.Dat.tab.val.querySelectorAll(`.sec.pul.${$.pul_ide}-${$.pul_val}:not(.${DIS_OCU})`),DIS_OCU);      

      if( $var.checked ){
        
        // muestro pulsar seleccionado
        Doc.act('cla_eli',$Doc.Dat.tab.val.querySelectorAll(`.sec.pul.${$.pul_ide}-${$.pul_val}.${DIS_OCU}`),DIS_OCU);
  ...
  static est( $ide ){
    ...
    case 'kin':
      ...
      case 'ton':
        ...
        Doc.act('cla_agr',$.sec_ini = $Doc.Dat.tab.val.querySelector('.sec.ini'),DIS_OCU);
        Doc.act('cla_agr',$.sec_fin = $Doc.Dat.tab.val.querySelector('.sec.fin'),DIS_OCU);
        ...
        if( $var.checked ){
          ...
          if( $Doc.Dat.tab.val.querySelector(`.sec.arm_cel:not(.${DIS_OCU})`) ){ 
            Doc.act('cla_eli',$.sec_fin,DIS_OCU);
          }          
        }
        else{
      ...
      case 'arm_cel': // derecho
        ...
        Doc.act('cla_agr',$.col = $Doc.Dat.tab.val.querySelector(`.sec.${ $.ide[1] == 'sel' ? 'ini' : 'fin' }`),DIS_OCU);
        
        if( $var.checked ){

          Doc.act('cla_eli',$Doc.Dat.tab.val.querySelectorAll(`.sec.${$.ide[1]}.${DIS_OCU}`),DIS_OCU);
          
          // muestro seccion
          if( $Doc.Dat.tab.val.querySelector(`.sec.ton:not(.${DIS_OCU})`) ){ 
            Doc.act('cla_eli',$.col,DIS_OCU);
          }
        }
        else{
          Doc.act('cla_agr',$Doc.Dat.tab.val.querySelectorAll(`.sec.${$.ide[1]}:not(.${DIS_OCU})`),DIS_OCU);
        }
