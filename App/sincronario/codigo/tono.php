...
<article>  
  ...
  <section id="<?="_{$Nav[1][$nv1]->pos}-"?>">
    ...
    <p>Luego<c>,</c> los <n>13</n> números se definen como <a href="<?=$Dir->libro?>factor_maya#_04-04-01-01-" target="_blank">Rayos de Pulsación</a> dotados con una <q>función radio<c>-</c>resonante en particular que pulsa e irradia simultáneamente</q><c>.</c> Esta progresión describe <q>la naturaleza formal que fundamenta la apariencia de las cosas</q> y <q>dan alguna idea de la progresión del ciclo estructural en el que se fundamenta la operación de la galaxia</q><c>.</c></p>
  ...
  <section id="<?="_{$Nav[1][$nv1]->pos}-"?>">
    ...
    <section id="<?="_{$Nav[2][$nv1][$nv2]->pos}-"?>">      
      ...
      <p>Los <b>Pulsares Dimensionales</b> están codificados por el código armónico de color y muestran la unidad de las dimensiones permitiendo crear relaciones a través del tiempo<c>.</c></p>
      ...
      <p>En <cite>Un Tratado del Tiempo</cite> se profundiza con los <a href="<?=$Dir->libro?>dinamicas_del_tiempo#_04-03-03-" target="_blank">Campos de Aplicación</a> y se describen sus funciones dentro de las <b>Articulaciones de la Onda Encantada</b><c>.</c></p>
