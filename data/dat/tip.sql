...
INSERT INTO `dat_tip` ( `ide`,`dat`,`val`,`nom`,`len`,`des`,`ope` ) VALUES

  -- vacios
    ( 'null',             'vac', 'nul', 'Nulo',             'php,jso',  'Valor no Definido','{ 
      "tip":"nov" 
    }'),
    ( 'undefined',        'vac', 'nod', 'Indefinido',       'php,jso',  'Tipo de Dato no Definido. Se utiliza en operaciones funcionales internas de los programas de procesamiento','{ 
      "tip":"not" 
    }'),
    ( 'nan',              'vac', 'non', 'No Numérico',      'php,jso',  'Tipo de dato NaN. Se utiliza en rutinas internas de los programas','{ 
      "tip":"non" 
    }'),
  
  -- numeros
    ( 'bool',             'num', 'bin', 'Booleano',         'sql',      'BOOL, BOOLEAN: Son sinónimos para TINYINT(1). Un valor de cero se considera falso. Valores distintos a cero se consideran ciertos','{ 
    }'),
    ( 'boolean',          'num', 'bin', 'Booleano',         'php,jso',  'Un valor de cero se considera falso. Valores distintos a cero se consideran ciertos','{ 
    }'),
  ...
  -- Listados
    ( 'enum',             'lis', 'uni', 'Único',            'sql',      'ENUM("value1","value2",...): Una enumeración. Un objeto de cadena de caracteres que sólo puede tener un valor, elegido de una lista de valores "value1", "value2", ..., NULL o el valor de error especial ". Una columna ENUM puede tener un máximo de 65,535 valores distintos. Los valores ENUM se representan internamente como enteros','{ 
      "lis_max":65535 
    }'),
    ( 'set',              'lis', 'mul', 'Múltiple',         'sql',      'SET("value1","value2",...): Un conjunto. Un objeto de cadena de caracteres que puede tener cero o más valores que deben pertencer a la lista de valores "value1", "value2", ... Una columna SET puede tener un máximo de 64 miembros. Los valores SET se representan internamente como enteros','{ 
      "lis_max":64 
    }' ),    
