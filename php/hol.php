  ...
  class _hol_bib {
    ...
    static function enc( string $ide, array $ope = [] ) : string {
      ...
      case 'ton':
        ...
        $_ = _app_est::lis("api.hol_ton", $est_ope, $ope );
        break;
        ...
        <form class='inf' esq='hol' est='$ide'>
          ...
          <div class = 'val'>
            ...
            <fieldset class='val'>
              ...
              "._app_ope::var('atr',"api.hol_kin.ide",[ 
    ...
    static function lun( string $ide, array $ope = [] ) : string {
      ...
      case 'lun_arm_col':
        ...
        $est_ope['opc'] []= 'cab_ocu';
        $_ = _app_est::lis("api.hol_lun_arm", $est_ope, $ope );
        break;
    ...
    static function tie( string $ide, array $ope = [] ) : string {
      ...
      case 'psi_vin':
        ...
        $_ = _app_est::lis("api.hol_{$ide}", $est_ope, $ope);
    ...
    static function rin( string $ide, array $ope = [] ) : string {
      ...
      case 'psi_lun_dia':
        ...
        elseif( empty($est_ope['atr']) ){
          $est_ope['atr'] = [];
          $_ = _app_est::lis("api.hol_lun", $est_ope, $ope );
        }
        break;
  ...
  class _hol_val {
    ...
    static function fec( array $dat, array $ope ) : string {
      ...
      <form class='val mar-1' ide='fec'>
        ...
        "._app_fec::ope('dia', $_fec, [ 'id'=>"_hol_app-val-fec", 'name'=>"fec", 
    ...
    static function kin( mixed $dat, array $ope = [] ) : string {
      ...
      foreach( [ 'nav_cas'=>52, 'nav_ond'=>13 ] as $atr => $cue ){ 
        ...
        <div class='tam-cre'>
          <p>"._app::let( _app_dat::val('nom',"api.hol_{$est}",$_dat) )."</p>
      ...
      foreach( [ 'arm_tra'=>13, 'arm_tra_dia'=>20, 'arm_cel'=>65, 'arm_cel_dia'=>4 ] as $atr => $cue ){ 
        ...
        <div class='tam-cre'>
          <p>"._app::let( _app_dat::val('nom',"api.hol_{$est}",$_dat) )."</p>
          <p>"._app::let( _app_dat::val('des',"api.hol_{$est}",$_dat) )."</p>
