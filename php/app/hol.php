...
class _app_hol {
  ...
  static function val( array $dat, array $ope ) : string {
    ...
    <form class='val fec mar-1'>
      ...
      "._app_var::fec('dia', $_fec, [ 'id'=>"hol_val-fec", 'name'=>"fec", 
    ...
    case 'kin':
      ...
      foreach( [ 'nav_cas'=>52, 'nav_ond'=>13 ] as $atr => $cue ){ 
        ...
        <div class='tam-cre'>
          ...
          <p>"._app_var::num('ran',$_kin->{"{$atr}_dia"},[ 'min'=>1, 'max'=>$cue, 'disabled'=>"", 'class'=>"anc-100"],'ver')."</p>            
        </div>";          
      }
      ...
      foreach( [ 'arm_tra'=>13, 'arm_tra_dia'=>20, 'arm_cel'=>65, 'arm_cel_dia'=>4 ] as $atr => $cue ){ 
        ...
        <div class='tam-cre'>
          ...
          <p>"._app_var::num('ran',$_kin->$atr,[ 'min'=>1, 'max'=>$cue, 'disabled'=>"", 'class'=>"anc-100"],'ver')."</p>          
        </div>";
      }
