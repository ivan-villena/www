...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"es",server:"1",table:"",db:"",token:"655145223e312d676a315b5528382369",text_dir:"ltr",LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",version:"5.2.0",auth_type:"config",user:"root"});
...
<body>
    <div id="pma_navigation" class="d-print-none" data-config-navigation-width="247">
  ...
  <a href="index.php?route=/table/recent-favorite&db=c1461857_api&table=hol_uni_sol_cir">
    `c1461857_api`.`hol_uni_sol_cir`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=c1461857_api&table=hol_uni_sol_pla">
    `c1461857_api`.`hol_uni_sol_pla`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=c1461857_api&table=hol_sel_par">
    `c1461857_api`.`hol_sel_par`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=c1461857_api&table=app_tab">
    `c1461857_api`.`app_tab`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=c1461857_api&table=hol_uni_sol_cel">
    `c1461857_api`.`hol_uni_sol_cel`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=c1461857_api&table=hol_uni_sol_orb">
    `c1461857_api`.`hol_uni_sol_orb`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=c1461857_api&table=hol_uni_pla_cen">
    `c1461857_api`.`hol_uni_pla_cen`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=c1461857_api&table=hol_uni_hum_cen">
    `c1461857_api`.`hol_uni_hum_cen`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=c1461857_api&table=hol_sel_cro_fam">
    `c1461857_api`.`hol_sel_cro_fam`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=c1461857_api&table=hol_chi">
    `c1461857_api`.`hol_chi`
  </a>
</li>
...
<div id='pma_navigation_tree_content'>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.YzE0NjE4NTdfYXBp" data-vpath="cm9vdA==.YzE0NjE4NTdfYXBp" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expandir/Colapsar" alt="Expandir/Colapsar" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=c1461857_api"><img src="themes/dot.gif" title="Opciones de la base de datos" alt="Opciones de la base de datos" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=c1461857_api" title="Estructura">c1461857_api</a>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander loaded container" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==" data-vpath="cm9vdA==.Y2Fj" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expandir/Colapsar" alt="Expandir/Colapsar" class="icon ic_b_plus">
        </a>
          </div>
          ...
          <div class="block second">
        <u><img src="themes/dot.gif" title="Grupos" alt="Grupos" class="icon ic_b_group"></u>
      </div>
      &nbsp;cac
  ...
  <li class="database database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.Y2FjX3BocA==" data-vpath="cm9vdA==.Y2Fj.cGhw" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expandir/Colapsar" alt="Expandir/Colapsar" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=cac_php"><img src="themes/dot.gif" title="Opciones de la base de datos" alt="Opciones de la base de datos" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=cac_php" title="Estructura">cac_php</a>
  ...
  <li class="database last database">
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.Y2FjX3JlYWN0" data-vpath="cm9vdA==.Y2Fj.cmVhY3Q=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expandir/Colapsar" alt="Expandir/Colapsar" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=cac_react"><img src="themes/dot.gif" title="Opciones de la base de datos" alt="Opciones de la base de datos" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=cac_react" title="Estructura">cac_react</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="655145223e312d676a315b5528382369">
...
<tr>
  ...
  <td>
          <input type="number" name="NavigationWidth" id="NavigationWidth" value="247" class="custom">
  ...
  <td>
          <input type="number" name="MaxNavigationItems" id="MaxNavigationItems" value="200" class="custom">
  ...
  <div id="pma_console_container" class="d-print-none">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Presione Enter para ejecutar la consulta                    </span>
                            ...
                            targetdb="c1461857_api" targettable="app_tab">
            ...
            Fecha y hora la consulta
                            ...
                            <span class="query">SELECT * FROM `app_tab`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="c1461857_api" targettable="hol_sel_par">
                            <div class="action_content">
                    <span class="action collapse">
            Colapsar
                    </span>
            ...
            Fecha y hora la consulta
                            ...
                            <span class="query">SELECT * FROM `hol_sel_par`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="c1461857_api" targettable="hol_sel_par">
                            <div class="action_content">
            ...
            Fecha y hora la consulta
                            ...
                            <span class="query">ALTER TABLE `hol_sel_par` ADD PRIMARY KEY(`ide`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="c1461857_api" targettable="hol_sel_par">
                            <div class="action_content">
            ...
            Fecha y hora la consulta
                            ...
                            <span class="query">SELECT * FROM `hol_sel_par`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="c1461857_api" targettable="hol_uni_sol_pla">
                            <div class="action_content">
                    <span class="action collapse">
            Colapsar
                    </span>
            ...
            Fecha y hora la consulta
                            ...
                            <span class="query">SELECT * FROM `hol_uni_sol_pla`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="c1461857_api" targettable="hol_uni_sol_cir">
                            <div class="action_content">
                    <span class="action collapse">
            Colapsar
                    </span>
            ...
            Fecha y hora la consulta
                            ...
                            <span class="query">SELECT * FROM `hol_uni_sol_cir`</span>
                        </div>
